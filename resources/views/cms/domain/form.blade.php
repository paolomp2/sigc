...
@endif
  ...
  <div class="form-group">
    <label class="control-label col-md-2 col-sm-3 col-xs-2" for="first-name">Nombre<span class="required">*</span>
    </label>
    <div class="col-md-10 col-sm-9 col-xs-10">
      <input autofocus type="text" minlength="5" maxlength="50"  id="name" name="name" class="form-control col-md-7 col-xs-12" placeholder="Nombre del dominio" value={!!'"'.$gc->entity_to_edit->name.'"'!!}>
    </div>
  </div>

  <div class="form-group">
    <label class="control-label col-md-2 col-sm-3 col-xs-2" for="last-name">Descripción<span class="required">*</span>
    </label>
    <div class="col-md-10 col-sm-9 col-xs-10">      
      <textarea minlength="5" maxlength="200" required="required" id="description" name="description" class="form-control col-md-7 col-xs-12" placeholder="Descripción del dominio">{!!$gc->entity_to_edit->description!!}</textarea>
    </div>
  </div>
